    ...
    return agent.callIds.map((callId, index) => (
      <tr key={index} className="border-b border-gray-300">
        ...
        <td className="p-2">
          ...
          >
            {isLoadingCallDetails && currentPlayingCallId === callId ? "Loading..." : "View Call Details"}
          </button>
        </td>
      </tr>
    ))
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto">
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-700">{callDetails.call_analysis?.user_sentiment || "Not available"}</p>
            </div>

            <div className="mb-4">
              <h3 className="font-semibold text-lg mb-2">Call Duration</h3>
              <p className="text-gray-700">
                {callDetails.duration_ms ? `${Math.round(callDetails.duration_ms / 1000)} seconds` : "Not available"}
              </p>
            </div>
