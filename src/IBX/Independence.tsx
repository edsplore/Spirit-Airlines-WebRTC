...
export default function Independence() {
  ...
  const [customerDetails, setCustomerDetails] = useState<CustomerDetails>(getRandomCustomer("Male", "Normal"))
      ...
      results.forEach((result, index) => {
        if (result.status === "fulfilled" && result.value) {
          ...
          newCallTimes[callId] = {
            ...
            duration: callData.duration_ms ? `${Math.round(callData.duration_ms / 1000)} seconds` : "N/A",
    ...
    try {
      ...
      if (selectedScenario === "Coverage & Benefits") {
        if (randomGender === "Male") {
          agentId =
            customerBehavior === "Normal" ? "agent_7352ccb9eec0070fb34dd210dd" : "agent_829b55de186580e2ae4046a3d4"
        } else {
          // Female
          agentId =
            customerBehavior === "Normal" ? "agent_9cb7f0e6409f7a855e5bebd451" : "agent_c7cb1579f542b18effe0968385"
        }
      } else {
        // Medical Card Replacement
        if (randomGender === "Male") {
          agentId =
            customerBehavior === "Normal" ? "agent_8510c8572ac35e4d17ed73d68b" : "agent_fed9a6e428a58b2ef8efa86cfe"
        } else {
          // Female
          agentId =
            customerBehavior === "Normal" ? "agent_6ac63093c84bd06926ec4d63aa" : "agent_202b46e07cedb67dcc3bfabdf8"
        }
      }
  ...
  const renderCallRecords = () => {
    ...
    if (searchTerm) {
      callRecords = callRecords.filter((call) =>
        Object.values(call).some((value) => value.toLowerCase().includes(searchTerm.toLowerCase())),
      )
    }
      ...
      callRecords.map((call, index) => (
        <tr key={index} className="border-b border-gray-300">
          ...
          <td className="p-2">
            ...
            >
              {isLoadingCallDetails && currentPlayingCallId === call.id ? "Loading..." : "View Call Details"}
            </button>
          </td>
        </tr>
      ))
    ...
    <div className="flex flex-col w-full h-screen bg-white overflow-hidden">
      <header className="flex justify-between items-center p-4">
        ...
        <div className="flex items-center gap-4">
          <span className="text-lg font-bold">Welcome, {userName || "User"}</span>
          {/* VI Labs logo */}
          <div className="flex items-center">
            <img src="/vi-labs.png" alt="VI Labs Logo" style={{ width: "200px", height: "auto" }} />
          </div>
        </div>
      </header>
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center border-b border-gray-300 pb-2">
                          ...
                          <div className="flex-1 relative">
                            ...
                            >
                              <span className={selectedAgent ? "text-black" : "text-gray-400"}>
                    ...
                    <table className="w-full border-collapse">
                      <tbody>
                        ...
                        <tr className="border-b border-gray-300">
                          ...
                          <td className="p-2 font-bold">{customerDetails.behavior}</td>
                        </tr>
                        <tr className="border-b border-gray-300">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={() => setShowCallSummary(false)} className="text-gray-500 hover:text-gray-700">
                <X size={24} />
              </button>
            </div>
            ...
            <div className="mb-4">
              ...
              <p className="text-gray-700">{callDetails.call_analysis?.call_summary || "No summary available"}</p>
            </div>

            <div className="mb-4">
              <h3 className="font-semibold text-lg mb-2">Transcript</h3>
              <div className="bg-gray-100 p-3 rounded-md max-h-40 overflow-y-auto">
                <pre className="whitespace-pre-wrap text-sm">{callDetails.transcript || "No transcript available"}</pre>
              </div>
            </div>
            ...
            {callDetails.recording_url && (
              <div className="mt-4">
                ...
                <audio ref={audioRef} controls className="w-full" src={callDetails.recording_url}>
